...
import { extractMarketAnalysis } from "@/Utils/function";
config()

export interface MarketAnalysis{
	HistoricalPerformanceInsight:string;
...
export async function GET(request: NextRequest) {
  ...
  if(tokenName.toLowerCase()==="usdc"){
   ...
   console.log(tokenId)
		 ...
		 const marketAnalysisDemo:MarketAnalysis={} as MarketAnalysis;
		 const {
			value,
        ...
        Guidelines:
		- Return the answer in the format of variable ${marketAnalysisDemo}
        ...
        - Ensure responses are structured, professional, and readable.
            ...
            - Should I hold, sell, or swap this token?
			  ...
			  const marketAnalysis: MarketAnalysis = extractMarketAnalysis(answer.agentResponse);
